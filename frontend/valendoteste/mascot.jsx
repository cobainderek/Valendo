// Valendo — mascote Valdo (coruja acadêmica doodle)
// Desenhado à mão com traços "wobbly" usando paths SVG

// Expressões: idle, cheer, think, confused, sleep
function Valdo({ size = 220, expression = 'idle', accessory = 'book', tilt = -4 }) {
  const w = size;
  const h = size * 1.15;

  // Eye shape varies with expression
  const renderEyes = () => {
    if (expression === 'sleep') {
      return (
  ...
  return (
    ...
    >
      ...
      {/* wings */}
      <path
        d="M 48 140 q -10 30 10 70 q 10 10 22 2"
        fill="#1B4FBE"
        stroke="#1A1A2E"
        strokeWidth="4"
        strokeLinejoin="round"
      />
      <path
        d="M 192 140 q 10 30 -10 70 q -10 10 -22 2"
        fill="#1B4FBE"
        stroke="#1A1A2E"
        strokeWidth="4"
        strokeLinejoin="round"
